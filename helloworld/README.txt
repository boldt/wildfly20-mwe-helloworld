...
a persistence unit "helloworldPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "helloworld\pom.xml":
...
artifact ("helloworld.war") is already built. You can build
